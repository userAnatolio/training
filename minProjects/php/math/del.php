...
<script>
/*
Программа принимает число(множимое) от пользователя, это число программа использует как делитель для чисел от 0 до 100.
Результат пользователь вводит сам, а прогамма проверяет правильно или неправильно, при этом результат и скорость
мышления будут доступны в самом конце.
При вводе первого результата, таймер начинает работать.
*/
// пользователь выбирает число (делитель от 1 до 100)
...
function func2(){
	...
	if(userResult != result){
		var text = count + ' / ' + userNum + ' = ' + userResult + " неправильно!";
		alert('Неправильно!');
